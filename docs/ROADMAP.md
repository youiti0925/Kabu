...
| P4.5 | attribution MVP (`kabu.attribution`: symbol / sector / period / rule_id / skip_reason / outcome、concentration warning、observation-only phrasing) | **本 PR で完了予定** |
